...
export default function Banner({
  ...
  return (
    <div
      className="relative isolate flex items-center gap-x-6 overflow-hidden bg-gray-50 px-6 py-2.5 sm:py-8.5 sm:before:flex-1"
      style={{ zIndex: "100" }}
    >
      <div
      ...
      >
        <div
          className="aspect-[577/310] w-[36.0625rem] bg-gradient-to-r from-[#bac7e2] to-[#9089fc] opacity-30"
