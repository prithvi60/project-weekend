...
const ModalForMobile = () => {
  ...
  return (
    ...
    type="button"
    onClick={openModal}
    className="absolute p-2 text-sm font-semibold text-black capitalize transition bg-white border border-white rounded-lg bottom-5 right-10 pointer md:mt-2"
  >
    enroll me
  </button>
